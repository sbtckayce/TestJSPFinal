...
<div class="main">
   ...
   ">
    ...
    background-color: #2f3542;">
                ...
                <div class="name-addpr">
                    <label >Name</label>
                    <input  value="${detail.name}" type="text" name="name" placeholder="Name :"  style="cursor: pointer">
                </div>
                <div class="linkimg-addpr">
                    <label>Image</label>
                    <input value="${detail.img}" type="text" name="image" placeholder="Link img :"  style="cursor: pointer">
                </div>
                <div class="price-addpr">
                    <label >Price</label>
                    <input value="${detail.newPrice}" type="text" name="price" placeholder="Price :" style="cursor: pointer">
                </div>
                <div class="decrip-addpr">
                    <label >Decription</label>
                    <textarea name="decription"  style="padding-left: 10px; cursor: pointer">${detail.decription}</textarea>
                </div>
    ...
    margin-left: 30px;
    padding: 3px 15px;">Cancel</a>
                    <input type="submit" class="submit-addpr" value="Edit" style="background:#7ed6df ; color: #fff ">
                </div>
            </form>
