...
@WebServlet(name = "AllDetailController", value = "/saledetail")
public class SaleDetail extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        AllProduct detailProductSales = AllProductDAO.getInstance().detailProductSaleByID(sid);

        request.setAttribute("detail",detailProductSales);
