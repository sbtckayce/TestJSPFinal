...
public class AllProductDAO {
    ...
    public AllProduct detailProduct(int pid){
    ...
    public void editSellProduct(String name,String decription,String newPrice,String img,String category,int id){
    ...
    public void addSellProduct(String name,String img ,int newPrice,String decription,int sid){
    ...
    public   List<AllProduct> sellProduct(int sid){
        List<AllProduct>list = new ArrayList<>();
...
//    detail
    ...
    public AllProduct detailProductZoneByID(String sid){
        return JDBIConnect.get().withHandle(handle -> {
            return handle.createQuery("SELECT * FROM allproduct WHERE id=? AND categoryProduct='xedap'")
                    .bind(0, sid)
                    .mapToBean(AllProduct.class).first();
        });
    }
...
// cảt
    ...
    public static void main(String[] args) {
        AllProductDAO a = new AllProductDAO();
        a.addSellProduct("moiadd","haha",12,"./assets/img/tivi/tv2.jpg",1);
//        a.editSellProduct("Kien187edi","haha","200000","./assets/img/tivi/tv2.jpg","1",183);
        List<AllProduct>list =a.sellProduct(1);

        for(AllProduct p:list){
