...
@WebServlet(name = "LoadProductSellController", value = "/loadproductsell")
public class LoadProductSellController extends HttpServlet {
    @Override
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        request.getRequestDispatcher("editsellproduct.jsp").forward(request,response);
    }
}
