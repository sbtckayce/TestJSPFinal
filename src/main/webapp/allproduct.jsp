...
<div class="main">
    ...
    <div class="menu-main">
        ...
        <div class="menu-product-new" style="background: #fff; " >
            <div class="menu-product-decription" id="menu-product" style="position: relative;border:none; margin: 30px auto ; background: #2f3542;">
                <c:forEach var="allpro" items="${allpro}">
                    <div class="item wow zoomIn producttop10" style="margin-bottom: 40px; border: none">
